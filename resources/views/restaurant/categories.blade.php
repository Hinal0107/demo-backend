            ...
            <tbody>
                @forelse($categories as $category)
                    <tr>
                        <td>
                            @if($category->image)
                                <img src="{{ app(\App\Services\ImageUploadService::class)->formatUrl($category->image) }}" alt="Category Image" style="width: 50px; height: 50px; object-fit: cover; border-radius: 6px;">
                            @else
